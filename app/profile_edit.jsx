    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ marginTop: 25, display: "flex", flexDirection: "row", justifyContent: "space-around" }}>
                ...
                >
                    {loading ? (
                        <Text style={{ fontSize: 15, color: "white" }}> <ActivityIndicator size={14} color="white" /> Saving</Text>
                    ) : (
                        <View style={{ display: "flex", flexDirection: "row", alignItems: "center" }}><FontAwesome name="save" size={14} color="white" /><Text style={{ fontSize: 15, color: "white" }}> Save</Text></View>
                    )}
                </TouchableHighlight>
            </View>
